 ...
 */
export const site = {
  title: "Godf1rst's Blog", // required
  favicon: '/favicon.svg', // required
  description: '欢迎来到我的博客! ',
  author: "Godf1rst", // required
  avatar: '/矢来美羽.png', // required
  url: 'https://godf1rst.github.io', // required
  baseUrl: 'my-astro-blog', // When using GitHubPages, you must enter the repository name startWith '/'. e.g. '/astro-blog'
...
export const infoLinks = [
  ...
  },
  {
    icon: 'ri-github-fill',
    name: 'github',
    outlink: 'https://github.com/godf1rst/astro-yi',
  },
  {
    icon: 'ri-rss-fill',
    name: 'rss',
